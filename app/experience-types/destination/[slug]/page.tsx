    ...
    <>
      ...
      <main className="w-full overflow-x-hidden">
        ...
        <section className="relative h-[70vh] sm:h-[85vh] lg:h-[96vh] w-full">
          ...
          {destination.imgTextSection && (
            <div
              className={`
                absolute inset-0 z-10 flex px-5 sm:px-10
                ${
                  destination.imgTextSection.vertical === "top"
                    ? "items-start pt-16"
                    : destination.imgTextSection.vertical === "bottom"
                    ? "items-end pb-16"
                    : "items-center"
                }
                ${
                  destination.imgTextSection.horizontal === "left"
                    ? "justify-start text-left"
                    : destination.imgTextSection.horizontal === "right"
            ...
            >
              ...
              ">
                {destination.imgTextSection.heading}
              </h1>
            </div>
          )}
         ...
         {destination.soloTrips && (
                <section className="mx-auto px-5 py-7  lg:py-7">
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                    ...
                    {/* LEFT TEXT */}
                    {destination.soloSectionIntro && (
                      <div className="lg:col-span-1">
                        <h2 className="text-3xl uppercase sm:text-4xl lg:text-6xl font-extralight leading-tight">
                          {destination.soloSectionIntro.heading}
                        </h2>

                        {destination.soloSectionIntro.subheading && (
                                      ...
                                      <div className="absolute bottom-0 p-5 text-white">
                                        ...
                                        <p
                                          className="
                                            ...
                                            lg:max-h-0 lg:opacity-0 lg:text-1xl
